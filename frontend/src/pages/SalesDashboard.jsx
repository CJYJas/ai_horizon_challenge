          ...
          <div className="p-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <div className="relative">
                ...
                <input type="text" placeholder="Search leads..." className="pl-9 pr-4 py-1.5 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-primary-500 focus:outline-none" />
              </div>
              <Button variant="secondary" className="px-3 py-1.5 h-auto text-sm bg-white"><Filter className="w-4 h-4 mr-2" /> Filter</Button>
            </div>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-200">
                {leads.map((lead, idx) => (
                  <tr key={idx} className="hover:bg-primary-50/50 transition-colors cursor-pointer group" onClick={() => navigate(`/leads/${lead.assessment_id}`)}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <p className="text-sm font-bold text-gray-900">{lead.company_name}</p>
                      <p className="text-xs text-gray-500 mt-1">{lead.company_industry}</p>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
