...
export function Report() {
  ...
  if (!data) return <div className="text-center py-20 text-red-500 no-print">Failed to generate report.</div>;
          ...
          <div className="p-8 space-y-12">
            ...
            <section className="page-break-before">
              ...
              <div className="grid gap-6">
                {report.pain_point_explanations.map((exp, idx) => (
            ...
            <section className="page-break-before">
              ...
              <div className="space-y-6">
                {Object.entries(report.roadmap_narrative).map(([phase, desc], idx) => (
                  <div key={idx} className="flex gap-4 page-break-inside-avoid">
                    <div className="flex flex-col items-center">
                      ...
                      {idx !== Object.keys(report.roadmap_narrative).length - 1 && (
